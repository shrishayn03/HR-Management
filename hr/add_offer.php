...
<div style="text-align:center;"><h1> ADD OFFER LETTER INFORMATION</h1></div>
...
<div class="container">
	...
	<div class="form-group row">
      ...
      <input type="text" class="form-control" id="type" placeholder="Enter Job Type" name="type" required>
      </div>
    </div>
	...
	<div class="form-group row">
      ...
      <input type="date" class="form-control" id="doj" placeholder="Enter Date Of Joining" name="doj" required>
      </div>
    </div>
